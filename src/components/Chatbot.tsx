...
export default function Chatbot() {
  ...
  const handleClear = () => {
    if (conversationId && confirm(t('chatbot_clear_confirm'))) {
      ...
      <div className="bg-blue-600 text-white p-4 rounded-t-lg flex items-center justify-between">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-xs opacity-75">{t('chatbot_subtitle')}</p>
          </div>
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 ? (
          <div className="text-center text-gray-500 mt-8">
            ...
            <p className="font-medium">{t('chatbot_greeting')}</p>
            <p className="text-sm mt-2">{t('chatbot_ask_about')}</p>
            <ul className="text-sm mt-2 space-y-1">
              <li>{t('chatbot_suggest_1')}</li>
              <li>{t('chatbot_suggest_2')}</li>
              <li>{t('chatbot_suggest_3')}</li>
              <li>{t('chatbot_suggest_4')}</li>
            </ul>
          </div>
        ) : (
          messages
